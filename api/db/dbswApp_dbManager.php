...
function getConnection() {
	...
	global $db_swApp_db_Url, $db_swApp_db_User, $db_swApp_db_Pass, $db_swApp_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_swApp_db_Url.";dbname=".$db_swApp_db_DbName, $db_swApp_db_User, $db_swApp_db_Pass);
